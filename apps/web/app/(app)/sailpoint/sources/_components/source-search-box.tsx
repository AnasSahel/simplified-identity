...
/**
 * Debounced free-text search for the Sources list. Mirrors the identities
 * SearchBox — pushes `q` into the URL after 250ms idle via `router.replace`
 * (no back-button entry per keystroke). Clearing `q` resets to page 1.
 */
export function SourceSearchBox({ initial }: { initial: string }) {
